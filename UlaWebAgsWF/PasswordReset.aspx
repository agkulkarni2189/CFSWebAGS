        ...
        <asp:Panel ID="PasswordResetPanel" runat="server">
            <form>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="NewPassword" runat="server" CssClass="form-control" TextMode="Password" Placeholder="Enter Password..." />
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="PasswordAgain" runat="server" CssClass="form-control" TextMode="Password" Placeholder="Re enter Password..." />
