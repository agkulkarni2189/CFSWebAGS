...
Sys.WebForms.Menu = function(options) {
    ...
    if (this.parentMenuItem && this.parentMenuItem.parentMenu) {
        ...
        if (this.depth > this.container.staticDisplayLevels) {
            ...
            if (this.rootMenu && this.container.orientation === 'Vertical' && this.parentMenu.isStatic()) {
...
Sys.WebForms.MenuItem = function(parentMenu, listElement, topLevelMenuItem) {
    ...
    if (this.parentMenu.depth == 1 && this.container.orientation == 'Vertical') {
        Sys.WebForms.Menu._domHelper.setFloat(this.element, this.container.rightToLeft ? "right" : "left");
    }
...
Sys.WebForms.MenuItem.prototype = {
    ...
    navigateParent: function() {
        var parentMenu = this.parentMenu,
            Vertical = this.container.orientation === 'Vertical';
        if (!parentMenu) return;
        if (Vertical && this.childMenu && parentMenu.isRoot()) {
            this.navigateChild();
            return;
        }
        if (parentMenu.parentMenuItem && !parentMenu.isRoot()) {
            if (Vertical && this.parentMenu.depth === 2) {
...
Sys.WebForms.Menu._keyboardMapping = new (function() {
    ...
    this.Vertical = { next: 0, previous: 1, child: 2, parent: 3, tab: 4 };
    this.Vertical[RIGHT_ARROW] = this.Vertical.next;
    this.Vertical[LEFT_ARROW] = this.Vertical.previous;
    this.Vertical[DOWN_ARROW] = this.Vertical.child;
    this.Vertical[UP_ARROW] = this.Vertical.parent;
    this.Vertical[TAB] = this.Vertical[ESCAPE] = this.Vertical.tab;
    this.VerticalRtl = { next: 0, previous: 1, child: 2, parent: 3, tab: 4 };
    this.VerticalRtl[RIGHT_ARROW] = this.VerticalRtl.previous;
    this.VerticalRtl[LEFT_ARROW] = this.VerticalRtl.next;
    this.VerticalRtl[DOWN_ARROW] = this.VerticalRtl.child;
    this.VerticalRtl[UP_ARROW] = this.VerticalRtl.parent;
    this.VerticalRtl[TAB] = this.VerticalRtl[ESCAPE] = this.VerticalRtl.tab;
    this.Vertical.contains = this.VerticalRtl.contains = this.vertical.contains = this.verticalRtl.contains = function(keycode) {
